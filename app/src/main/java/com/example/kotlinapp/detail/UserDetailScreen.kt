...
import com.example.kotlinapp.detail.UserDetailViewModel
    ...
    Scaffold(
        ...
        Box(
            ...
            when (val state = uiState) {
                ...
                is UserDetailUiState.Success -> UserDetailContent(user = state.user)
                is UserDetailUiState.Error -> ErrorContent(
...
private fun UserDetailContent(user: User) {
    Column(
        ...
        Text(
            text = "Related to User #${user.userId}",
